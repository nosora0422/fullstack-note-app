    ...
    return(
        <div>
            ...
            <ul className="my-grid">
                {fEntries.length > 0 ? fEntries.map((item) => (<Note key={item.id} item={item} delRef={delRef} />)) : <li className="col-span-12 w-full py-4 px-6 rounded-md -bg--surface-bright">No items to display</li>}
            </ul>
        </div>
